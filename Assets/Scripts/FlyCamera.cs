...
public class FlyCamera : MonoBehaviour {
    ...
    public float mainSpeed = 600.0f; //regular speed
    public float shiftAdd = 500.0f; //multiplied by how long shift is held.  Basically running
    public float maxShift = 1500.0f; //Maximum speed when holdin gshift
    public float camSens = 2f; //How sensitive it with mouse
